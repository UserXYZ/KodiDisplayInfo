...
class DrawToDisplay_AudioTime:
	...
	_drawSetting['audioinfo.button.menu'] = ""
	...
	def SetupDrawSetting320x240(self):
		...
		self._drawSetting['audioinfo.button.play'] = self.pygame.image.load(self._ConfigDefault['basedirpath']+'img/64x64/play.png')
		...
		self._drawSetting['audioinfo.button.break'] = self.pygame.image.load(self._ConfigDefault['basedirpath']+'img/64x64/pause.png')
	...
	def drawProperties(self, audio_title, time_now, speed, media_time, media_timetotal):
		...
		r_menu = self._drawSetting['audioinfo.button.menu'].get_rect().inflate(-8, -10)
		self._drawSetting['menu'] = Rect((self._drawSetting['audioinfo.menu.right'] - 32, self._drawSetting['audioinfo.menu.margin_top']), (r_menu[2], r_menu[3]))
